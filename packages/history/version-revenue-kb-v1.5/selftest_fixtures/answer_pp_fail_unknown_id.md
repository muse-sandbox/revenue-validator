# Synthetic answer — proposal cites a nonexistent source (selftest)

1. **Verdict** — launch with changes. Synthetic rationale.

## Product proposals

- **[segment]** Restrict the invented widget to the synthetic cohort —
  grounded in T9-77. Expected direction: invented metric up on that cohort.
