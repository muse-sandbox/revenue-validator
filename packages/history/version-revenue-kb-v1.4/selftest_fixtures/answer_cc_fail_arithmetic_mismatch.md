# Synthetic answer — computed claim whose arithmetic does not hold (selftest)
...
- [computed] 64% × (1 − 25%) ≈ 61% of the test arm reaches the widget,
  which is above the 3 pp this design resolves.
