# Combined Validator Prompt V1.4 (frozen 2026-08-07, FLOW-632)

This is the frozen prompt for BOTH arms of the KB V1.4 evaluation
...
V1.4 differs from V1.3 in exactly two places: rule 8 gains the fourth
statement label `[computed]` for arithmetic over the numbers of the card
under review (KNOWLEDGE CONTEXT §2.8), and the output format gains the
mandatory MAIN section `## What this experiment cannot show`, which is where
that arithmetic goes. Rule 4 is deliberately untouched — the ban on
transferring magnitudes from other experiments stands, and §2.8 explicitly
does not weaken it. Rules 1–7 and 9–12, the closeness model, the analog-card
...
answer has a MAIN part and an APPENDIX, the mandatory
...
with the full checklist in the appendix.
