#!/usr/bin/env python3
"""Deterministic answer linter for Revenue Validator V1.3 (FLOW-624).
...
Machine check of a validator answer against
  ...
  * the scope rules for corpus-level generalizations of §2.5, using the
    machine-readable generalization classes of §2.6 (V1.2); and
  * the grounding rules for product proposals of §2.7 (new in V1.3).
