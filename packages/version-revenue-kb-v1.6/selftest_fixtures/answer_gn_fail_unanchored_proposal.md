...
- **[segment]** [topic: synthetic-cohort-readout] *If:* the synthetic cohort is read out separately before any rollout. *Grounds:* [fact] P-90 covers this synthetic surface and records the same split. *Then:* the goal metric is unchanged, the readout is cleaner.
