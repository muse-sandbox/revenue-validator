...
The nearest synthetic case is T9-01; it differs in nothing that matters here.

```yaml
analog:
  source: T9-01 (synthetic selftest case)
  axes:
    flow_stage: exact
    segment: exact
  ...
  level: L1
  transferable: >
    [fact] Synthetic measurement in the invented source.
  not_transferable: >
    Synthetic magnitudes do not transfer.
```
