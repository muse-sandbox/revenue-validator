# Synthetic answer — knowledge-base magnitude dressed as a calculation (selftest)
...
- [computed] 64% × (1 − 25%) ≈ 48% of the test arm reaches the widget,
  so the effect lands at 37% of exposed users in the overall metric.
