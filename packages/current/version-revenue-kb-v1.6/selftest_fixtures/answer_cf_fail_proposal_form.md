...
- **[mechanic]** [topic: passive-toast-synthetic-surface] Run the invented widget as a passive toast instead of an interrupt, keeping the 64% branch reach — grounded in T9-01 (L1 card below), which read its own lift as coming from the passive form. The invented metric moves up on the exposed users.
