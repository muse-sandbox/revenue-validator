# Synthetic answer — typed proposal without a source (selftest)

1. **Verdict** — launch with changes. Synthetic rationale.

## Product proposals

- **[offer]** Bundle the invented widget with a made-up annual plan; it
  feels like it would convert better. Expected direction: invented metric up.
