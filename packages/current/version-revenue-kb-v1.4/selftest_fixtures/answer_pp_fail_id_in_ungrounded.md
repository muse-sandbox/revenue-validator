# Synthetic answer — abstention carrying a source ID (selftest)

1. **Verdict** — launch with changes. Synthetic rationale.

## Product proposals

- **[mechanic]** Run the invented widget as a passive toast — grounded in
  T9-01 (L1 card below). Expected direction: invented metric up.
- **[ungrounded]** A made-up annual bundle would probably help too, roughly
  as in T9-01.
