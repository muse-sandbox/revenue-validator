...
KNOWLEDGE CONTEXT собран конкатенацией `knowledge_base.md` + `\n\n` +
`pattern_cards.md`. Канонический разделитель по `FREEZE_MANIFEST.md` версии
V1.2 — `\n\n---\n\n`.

Разница 5 байт, содержание идентично, но вход не байт-в-байт совпадает с
протокольным:

- канонический: `9949e10b34df6c2e…`, 72 949 байт
- использованный: `97cc260a3bd45fa5…`, 72 944 байта

Прогон остаётся пригодным как пробный. Для зачётного кейса пилота вход нужно
собирать каноническим разделителем.
